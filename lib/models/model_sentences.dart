...
class ModelStyle extends StatefulWidget {
  final CustomCardModel2 cardModel;
...
class _ModelStyleState extends State<ModelStyle> {
  ...
  Widget build(BuildContext context) {
    String sentence = this.widget.cardModel.subImage.split('/').last.split(".").first;
    return Container(
      height: 230,
      child: Column(
        children: [
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          Future.delayed(Duration(milliseconds: 800), () {
                            ...
                            flutterTts.speak("This is ${sentence[0] == 'a'|| sentence[0]=='e'|| sentence[0]=='i'|| sentence[0]=='o'|| sentence[0]=='u'?"an":"a"} ${this.widget.cardModel.subImage.split('/').last.split(".").first}");
                            flutterTts.setPitch(1);
                          });
                  ...
                  child: Container(
                    ...
                    child: Directionality(
                      ...
                      child: Column(
                        children: [
                          PrimaryText(
                            text: ("This is ${sentence[0] == 'a'|| sentence[0]=='e'|| sentence[0]=='i'|| sentence[0]=='o'|| sentence[0]=='u'|| sentence[0]=='x'?"an":"a"} ${this.widget.cardModel.subImage.split('/').last.split(".").first}"),
