...
class BodyPartsPuzzle extends StatefulWidget {
  _BodyPartsPuzzleState createState() => _BodyPartsPuzzleState();
}

class _BodyPartsPuzzleState extends State<BodyPartsPuzzle> {
            ...
            children: [
              ...
              JigsawPuzzle(
                ...
                onFinished: () {
                  ...
                  starting = false;
                  if(_scoreModel.puzzle!=null){
                    if(_scoreModel.puzzle!>dateTime.value.inMilliseconds/1000){
                      print(_scoreModel.puzzle);
                      _scoreModel.puzzle = dateTime.value.inMilliseconds/1000;
                      update(_scoreModel);
                    }
                  }else{
                    ScoreModel scoreModel = ScoreModel();
                    scoreModel = _scoreModel;
                    scoreModel.puzzle = dateTime.value.inMilliseconds/1000;
                    update(scoreModel);
                  }
                  print('finished!');
                },
