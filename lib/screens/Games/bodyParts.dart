...
class BodyPartsGameScreen extends StatefulWidget {
  @override
  _GameScreenState createState() => _GameScreenState();
}

class _GameScreenState extends State<BodyPartsGameScreen> {
  int selectedCard = -1;
  @override
    ...
    return InkWell(
      onTap: () => {
        setState(
            ...
            selectedCard = index,
            Navigator.pushNamed(
                context, bodyPartsGameRoutes[index]['routePath'].toString())
          },
        ),
      },
      child: Container(
