...
class TabsGames extends StatefulWidget {
  @override
  _GameScreenState createState() => _GameScreenState();
}

class _GameScreenState extends State<TabsGames> {
  int selectedCard = -1;
  @override
    ...
    return InkWell(
      onTap: () => {
        setState(
            ...
            selectedCard = index,
            Navigator.pushNamed(
                context, tabsGameRoutes[index]['routePath'].toString())
          },
        ),
      },
      child: Container(
  ...
  SizedBox buildCards(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.builder(
        itemCount: tabsGameList.length,
        itemBuilder: (BuildContext context, int index) {
          return cardsStyle(tabsGameList[index]['imagePath'].toString(),
              tabsGameList[index]['GameName'].toString(), index);
        },
      ),
    );
  }
