...
class AllPuzzleGames extends StatefulWidget {
  @override
  _GameScreenState createState() => _GameScreenState();
}

class _GameScreenState extends State<AllPuzzleGames> {
  int selectedCard = -1;
  @override
    ...
    return InkWell(
      onTap: () => {
        setState(
            ...
            selectedCard = index,
            Navigator.pushNamed(
                context, allPuzzleGameRoutes[index]['routePath'].toString())
          },
        ),
      },
      child: Container(
  ...
  SizedBox buildCards(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.builder(
        itemCount: allPuzzleGameList.length,
        itemBuilder: (BuildContext context, int index) {
          return cardsStyle(allPuzzleGameList[index]['imagePath'].toString(),
              allPuzzleGameList[index]['GameName'].toString(), index);
        },
      ),
    );
  }
